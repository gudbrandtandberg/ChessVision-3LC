...
if __name__ == "__main__":
    ...
    convert_segment_masks_to_yolo_seg(
        "data/board_extraction/yolo/masks/train",
        "data/board_extraction/yolo/labels/train",
        classes=255,
    )
    convert_segment_masks_to_yolo_seg(
        "data/board_extraction/yolo/masks/val",
        "data/board_extraction/yolo/labels/val",
        classes=255,
    )
